...
<div class="libre-translate-dialog">
    ...
    private async loadLanguages(): Promise<void> {
        try {
            ...
            this.showError(this.getI18n("error") + ": " + e.userMessage);
        }
    }
    ...
    private async detectLanguage(): Promise<void> {
        ...
        try {
            ...
            if (result && result.length > 0) {
                ...
                this.detectLabel.textContent = `${this.getI18n("languageDetected")} ${detected.language.toUpperCase()} (${Math.round(detected.confidence)}%)`;
            }
        } catch (e: any) {
    ...
    private async translate(): Promise<void> {
        ...
        try {
            ...
            if (e instanceof LibreTranslateApiError) {
                ...
                this.showError(this.getI18n("error") + ": " + e.message);
            }
        } finally {
