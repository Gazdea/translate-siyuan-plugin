...
export class SettingsPanel {
    ...
    private createApiUrlSetting(): void {
        ...
        titleElement.className = "b3-label";
        titleElement.textContent = this.getI18n("apiUrl");
        ...
        descElement.className = "b3-label__text";
        descElement.textContent = this.getI18n("apiUrlPlaceholder");

        titleElement.appendChild(this.apiUrlInput);
    ...
    private createHotkeySetting(): void {
        this.setting.addItem({
            ...
            createActionElement: () => {
                ...
                this.hotkeyInput.placeholder = this.getI18n("hotkeyPlaceholder");
